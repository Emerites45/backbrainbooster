...
public class TaskHistoryController {
    ...
    public TaskHistoryController(IActionHistoryService historyService) {
        this.historyService = historyService;
    }

    @GetMapping
    @Operation(summary = "Historique d’une tâche")
    public ResponseEntity<PageResponse<ActionHistoryResponse>> list(
        ...
        return ResponseEntity.ok(historyService.listTaskHistory(taskId, pageable));
    }
}
